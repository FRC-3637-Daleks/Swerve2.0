 ...
 *
 * Note, this is only really a benefit when utilizing the CANIvore AND Phoenix
 * Pro. When combined, high-throughput low-latency sensing signals can be
 * received from the CAN bus. With phoenix pro, these signals are also time
 * syncronized. This means that the sensor information from all the swerve
 * modules is received simultaneously, which is good for 2 reasons.
