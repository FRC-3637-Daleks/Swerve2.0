  ...
  struct SignalGroup {
    ...
    static bool WaitForAllSignals(units::time::second_t timeout,
      ...
      return ctre::phoenix6::BaseStatusSignal::WaitForAll(
        timeout, groups.m_drivePosition...,
        groups.m_driveVelocity..., groups.m_steerPosition...,
        groups.m_steerVelocity...) !=
...
public:
  ...
  // Getters will not return different values until signals are refreshed
  // again
  void RefreshSignals();
